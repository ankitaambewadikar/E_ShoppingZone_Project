...
<html lang="en">
<head>
<title>E-ShoppingZone.com</title>
<meta charset="utf-8">
		...
		<div class="row">
			<div class="col-sm-4">
				<img
					...
					alt="Image">
				<p>Price:Rs 40800</p>
				<a class="productName1" href="searchProducts?productId=106">Acer
					Aspire E15 Laptop</a>
				<p>
			...
			<div class="col-sm-4">
				...
				<p>Price:Rs 4995</p>
				<a class="productName2" href="searchProducts?productId=138">Sujata
			...
			<div class="col-sm-4">
				<img
					...
					alt="Image">
				<p>Price:Rs 244</p>
				<a class="productName3" href="searchProducts?productId=111">The
			...
			<div class="col-sm-4">
				<img
					...
					alt="Image">
				<p>Price:Rs 1299</p>
				<a class="productName4" href="searchProducts?productId=122">Fur
			...
			<div class="col-sm-4">
				<img
					...
					alt="Image">
				<p>Price:Rs 2004</p>
				<a class="productName5" href="searchProducts?productId=141">Adidas
			...
			<div class="col-sm-4">
				<img
					...
					alt="Image">
				<p>Price:Rs 199</p>
				<a class="productName6" href="searchProducts?productId=151">Fitkit
			...
			<div class="col-sm-4">
				<img
					...
					alt="Image">
				<p>Price:Rs 599</p>
				<a class="productName7" href="searchProducts?productId=161">Dennis
			...
			<div class="col-sm-4">
				<img
					...
					alt="Image">
				<p>Price:Rs 55990</p>
				<a class="productName8" href="searchProducts?productId=171">Sony
			...
			<div class="col-sm-4">
				<img
					...
					alt="Image">
				<p>Price:Rs 24800</p>
				<a class="productName8" href="searchProducts?productId=107">Vivo
					V9</a>
				<p>
